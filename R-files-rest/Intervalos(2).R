...
###################################################
# Tamaño de muestra apropiado usando función de R #
###################################################
...
###Asumiendo diferencia crítica en las medias 0.5
###Asumiendo desviación estándar de 0.25
...
# Si se busca el tamaño de muestra, n debe ser null
