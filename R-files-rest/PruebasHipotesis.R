...
# Valor cr?tico, cambia de acuerdo a la direcci?n de la prueba
...
# ?til cuando n es peque?o y no se cumple el supuesto de normalidad
...
Z_c<- (X1-X2)/sqrt((sigma_poblacion/length(S))+(sigma_poblacion/length(N)))
